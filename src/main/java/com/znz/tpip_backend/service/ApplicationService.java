...
public class ApplicationService {
    ...
    // // 1. validate NEXT step requirements
    // validateStepCompletion(app, nextStep);
...
// // ================= MOVE STEP =================
// public Application moveToStep(Long applicationId, ApplicationStep step) {
...
// if (!isValidStepTransition(app.getCurrentStep(), step)) {
// throw new IllegalStateException("Invalid step transition");
// }
...
// if (app.getReferees() == null || app.getReferees().size() < 2) {
// throw new IllegalStateException("Minimum 2 referees required");
// }
...
// public Application updateStatus(Long applicationId, ApplicationStatus
// newStatus) {
...
// // ================= STEP VALIDATION =================
// private boolean isValidStepTransition(ApplicationStep current,
// ApplicationStep next) {
// return next.getOrder() <= current.getOrder() + 1;
// }

// // ================= STATUS VALIDATION =================
// private boolean isValidStatusTransition(ApplicationStatus current,
...
// }
// // ================= INDEX GENERATOR =================
// // Generated per intake, Used for tracking application, Used for admission
// // process
// // private String generateApplicationIndex(Intake intake) {

// // String year = intake.getName(); // e.g. 2025/2026

// // long count = applicationRepository.count() + 1;

// // return String.format("APP/%s/%05d", year, count);
// // }
// private String generateApplicationIndex(Intake intake) {
